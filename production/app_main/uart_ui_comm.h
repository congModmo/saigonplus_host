...
typedef enum{
	...
	UART_UI_CMD_TEST_ALL_HW		=133,
	UART_UI_CMD_TEST_OTHER		=134,
	UART_UI_CMD_TEST_BLE		=135,
	UART_UI_CMD_TEST_LTE		=136,
	UART_UI_CMD_TEST_GPS		=137,
	UART_UI_CMD_TEST_IMU		=138,
	UART_UI_CMD_TEST_IO			=139,
	UART_UI_CMD_TEST_NETWORK	=140,
	UART_UI_CMD_TEST_MQTT		=141,
	UART_UI_CMD_TEST_FUNCTION 	=142,
	UART_UI_CMD_READOUT_PROTECT	=143,

	UART_UI_LTE_CERT			=150,
	UART_UI_LTE_KEY				=151,
	UART_UI_CMD_IMPORT_KEY 		=152,
